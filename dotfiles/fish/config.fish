if status is-interactive
    ...
    # ─────────────────────────────────────────────────────────────────
    # COLORS & SYNTAX HIGHLIGHTING - Noctalia Dynamic Theme
    # ─────────────────────────────────────────────────────────────────

    # Source the theme generated by apply-theme.sh
    if test -f ~/.config/fish/themes/noctalia.fish
        source ~/.config/fish/themes/noctalia.fish
    end
...
if test -f /home/jon/tools/Miniconda/bin/conda
    eval /home/jon/tools/Miniconda/bin/conda "shell.fish" hook $argv | source
else
    if test -f "/home/jon/tools/Miniconda/etc/fish/conf.d/conda.fish"
        . "/home/jon/tools/Miniconda/etc/fish/conf.d/conda.fish"
    else
        set -x PATH /home/jon/tools/Miniconda/bin $PATH
    end
end
# <<< conda initialize <<<
